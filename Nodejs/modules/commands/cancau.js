...
const canCauList = {
    "rẻ":      { name: "Cần Ngưng Khí",    price: 0,           rate: 0.1 },  // Giai đoạn đầu tiên
    "trung":    { name: "Cần Trúc Cơ",     price: 5000,        rate: 0.25 }, // Bắt đầu tu tiên thực thụ
    "mắc":      { name: "Cần Kết Đan",     price: 50000,       rate: 0.45 }, // Hình thành nội đan
    "xịn":      { name: "Cần Nguyên Anh",  price: 250000,      rate: 0.65 }, // Có thể xuất khiếu
    "thần":     { name: "Cần Hoá Thần",    price: 1500000,     rate: 0.8 },  // Bước vào cảm ngộ ý cảnh
    "siêu":     { name: "Cần Anh Biến",    price: 10000000,    rate: 0.9 },  // Sức mạnh vượt trội
    "vinhcuu":  { name: "Cần Vấn Đỉnh",    price: 100000000,   rate: 0.95 }, // Đỉnh cao của bước thứ nhất
    "vohan":    { name: "Cần Thiên Tôn",   price: 0,           rate: 1.0 }   // Bước vào hàng ngũ cường giả Thái Cổ
};
